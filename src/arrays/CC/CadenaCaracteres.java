...
public class CadenaCaracteres {
    ...
    Crea una clase llamada CadenaCaracteres. En ella debes de tener tantos métodos como 
    ejercicios se plantean a continuación y un método opcionesMenu.
    ...
    public  void opcionesMenu() {
        ...
        while (numero_menu != 0) {
            ...
            System.out.println("0. Para salir del menú. "
                    + "\n1.Opcion 1: Apartado 4.1." 
                    + "\n2.Opción 2: Apartado 4.2."
                    + "\n3. Opción 3: Apartado 4.3.");
    ...
    /*3.Crea una variable global (o atributo) que contenga el texto del archivo 
    adjunto en una variable. (Recomiendo la lectura del texto ya
    que es gracioso y puede ser que veáis esta situación en el mundo laboral).*/
    String texto = "El código\n"
            ...
            + "\n"
            + "Enviar.";
    /*4.Mediante el uso de los métodos que poseen las cadenas de caracteres realiza un menú con el código necesario 
    para que haga las siguientes funciones:
    4.1.Busque en el texto cuantas veces aparece la palabra "$Hyperboss" y lo indique por pantalla.*/
    public void buscarPalabra() {
        //Creamos un Array al que llamamos "array"
        String array[];
        int contador = 0;
        /*Guardamos en la variable array el número de palabras que contiene la variable texto.
        El método ".split()", separa el contenido de la variable "texto" tipo String, dependiendo de lo
        que le digamos entre los paréntesis "()".
        */
        /*En este caso, el método split separa el contenido de la variable texto por "espacios",almacenándolo en la variable "array"
        ya que entre los paréntesis he puesto ("espacioEnBlanco")
        */
        array = texto.split(" ");
        for (int x = 0; x < array.length; x++) {
           // Muestra el número de palabras que contiene la variable creada en su posicion empezando desde "0", tipo String texto: System.out.println("array: " + array[x]);
           //Donde "x" hace referencia a la posición
           //Método ".equals" comparar cadenas
            if (array[x].equals("$Hyperboss")) {
                contador++;
            }
        }
        System.out.println("La palabra $Hyperboss aparece en el texto " + contador + " veces.");
    }
    /*4.2.Busque la palabra "$Hyperboss" y la sustituya por "COÑAZO". Además, debe de colorearla 
    de azul cuando muestre el texto por pantalla (investigar por internet como se puede hacer).*/
    public void sustituirPalabra(){
        //Creamos un Array al que llamamos "array2"
        String palabras[];
        int contador = 0;
        String textoNuevo = "";
        ...
        for (int x = 0; x < palabras.length; x++){
            if (palabras[x].equals("$Hyperboss")){
                //Para poder reemplzar cadenas se usa método: ".replace"
                 textoNuevo = texto.replace(palabras[x], colorAzul+"COÑAZO");
        ...
        System.out.println("El texto con la palabra $Hyperboss sustituida por la palabra"+colorAzul+ " Coñazo: " +palabras );
    }
    //4.3.Mostrar por pantalla la primera frase en la que aparece la palabra "$Hyperboss".
    public  void mostrarFrase() {
        ...
        while (encontrado == false) {
            ...
            String lineaValorX = linea[x].toString();

            if (lineaValorX.contains("$Hyperboss")) {
                encontrado = true;
        ...
        System.out.println("La primera frase en la que aparece la palabra $Hyperboss es: " + linea[x - 1]);
    }
}
